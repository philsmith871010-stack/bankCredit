...
LOCATORS += [
    ...
    dict(entity="goldman-sachs", kind="pattern", template="us_lcr", currency="USD",
         urls=["https://www.goldmansachs.com/investor-relations/financials/other-information/{year}/{q}q-{year}-liquidity-coverage-ratio.pdf",
               "https://www.goldmansachs.com/investor-relations/financials/other-information/{year}/{q}q-liquidity-coverage-ratio-{year}.pdf"]),
    dict(entity="goldman-sachs", kind="pattern", template="us_capital", currency="USD",
         urls=["https://www.goldmansachs.com/investor-relations/financials/other-information/{year}/{q}q-pillar-3-{year}.pdf",
               "https://www.goldmansachs.com/investor-relations/financials/other-information/{year}/{q}q-pillar3-{year}.pdf",
               "https://www.goldmansachs.com/investor-relations/financials/other-information/{year}/{q}q-{year}-pillar-3.pdf"]),
